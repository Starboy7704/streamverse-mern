...
const AuthScreen = () => {
  ...
  return (
    ...
    <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
        <img src='/sv_logo-removebg.png' alt='logo' className='w-32 md:w-52'/>
    ...
    <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
        <h1 className='text-4xl md:text-6xl font-bold md-4'>Unlimted movies,Tv shows and more</h1>
    ...
    <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
        ...
        <div className='flex-1 text-center md:text-left'>
            ...
            <p className='text-lg md:text-xl'>
                Stream unlimted movies and TV shows on your phone, tablet, laptop, and TV
            </p>
        </div>
        {/* right side */}
    ...
    <p className='text-lg md:text-xl'>
        Send kids on adventures with their favorite in a space made just for them-free with your membership.
    </p>
